...
class Thread {
  ...
  void setOPriority(int ) ;
  int getPriority() {return (Priority);}
  int getOPriority() {return (Original_Priority);}
  double setBurst(double);
  double getBurst(){return Burst_time;}
  void setWait(int);
  int getWait(){ return Wait_time; }
  void setLWait(int);
  int getLWait(){ return last_wait_time; }
